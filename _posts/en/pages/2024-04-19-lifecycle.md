...
This document describes the life-cycle of the Dpowcoin Core software package released by the Dpowcoin Core project. It is in line with standard maintenance policy across commercial software.  

## Versioning

Dpowcoin Core releases are versioned as follows: MAJOR.MINOR, and release candidates are suffixed with rc1, rc2 etc.
...
\* _We aim to make a major release every 9-10 Months - Year_

_TBA: to be announced_

## Protocol versioning

The description above only describes Dpowcoin Core software releases. Many other parts of the Dpowcoin system contain their own versions.  A few examples:
